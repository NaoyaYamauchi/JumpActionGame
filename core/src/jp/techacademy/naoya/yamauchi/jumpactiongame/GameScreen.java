...
public class GameScreen extends ScreenAdapter {
    ...
    static final float WORLD_HEIGHT = 15 * 20;//20画面分
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.naoya.yamauchi.jumpactiongame");
    ...
    private void updatePlaying(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            mGuiViewPort.unproject(mTouchPoint.set(Gdx.input.getX(), Gdx.input.getY(), 0));//これ修正じゃない？
